...
const buttonCommon = ['transition-all font-medium', 'rounded-md', 'disabled:opacity-50'].join(' ')
...
export const buttonCN = {
  ...
  shadow: 'duration-300 transition-shadow shadow hover:shadow-md hover:shadow-red-200'
}
